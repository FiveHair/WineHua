...
export const switchCompositorMode: (desktop: boolean) => boolean;
export const replayToplevels: (excludePid: number) => void;
export const startExplorerDesktop: () => boolean;
export const stopExplorerDesktop: () => number;
export const startBareExplorer: () => boolean;
