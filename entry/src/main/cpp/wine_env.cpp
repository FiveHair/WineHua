                         ...
                         const std::string& binDir)
{
    if (d3dBackend == "vkd3d_limited_500k")
    {
        ...
        const std::vector<std::string> managed = {
            ...
            "VN_WINEHUA_PERSISTENT_MAP_SYNC=0",
            "VN_WINEHUA_DIRECT_FENCE_WAIT=1",
            "VKR_WINEHUA_SHADOW_FROM_HOST=precise",
            "VKD3D_WINEHUA_FORCE_COHERENT_MAP_SYNC=0",
            "VKD3D_WINEHUA_GPU_UPLOAD=1",
            "WINEDLLOVERRIDES=d3d12=n;d3d11=n;dxgi=n;EOSSDK-Win64-Shipping=",
